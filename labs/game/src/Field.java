...
int a;
    ...
    private void drawGrid() {
        ...
        graphics1.drawLine(BI.getWidth() - 1, BI.getWidth() - 1, BI.getWidth() - 1, 0);
        graphics1.drawLine(BI.getWidth() - 1, BI.getWidth() - 1, 0, BI.getWidth() - 1);
    }
        ...
        Graphics graphics = BI.getGraphics();
            ...
            for (int x = 0; x < squareNumber; x++)
                ...
                if(mas[x][y] == 9 ){
                   ...
                   graphics.fillRect(size*x +1  , size*y +1 , size*(x+1)+1, size*(y+1)+1 );
